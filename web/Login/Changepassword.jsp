...
<body>
  <div class="wrapper">
  <form class="login" id="ChangePass">
   <img align="center" style="width: 260px; margin: 5px; " src="../Img/DonDur1.png" alt="">
   <br>
    <br>
    <input type="text" name="Email" id="Email" placeholder="Ingresar Correo Electronico" autofocus/>
    <i class="fa fa-user"></i>
    <button>
      <i class="spinner"></i>
      <span  class="state">Recuperar Contraseña</span>
    </button>
  </form>
  ...
  <script src="../Js/jquery-2.2.0.min.js" type="text/javascript"></script>
    ...
    <script src="../Js/JsLonginDD/LoginChange.js"></script>
