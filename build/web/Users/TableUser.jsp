        ...
        <div class="content">
            ...
            <div class="fresh-table full-color-orange">
                ...
                <table id="fresh-table" class="table">
                    <center><h3 style="right:">Lista de Empleados</h3></center>
                    ...
                    <tbody>
                        <jsp:useBean id="UserController"  scope="page"  class="Controller.UserController"/>
                        <%
                            if (UserController.getUserList() != null && UserController.getUserList().size() > 0) {
                                for (UserEntity user : UserController.getUserList()) {

                        %>

                        <tr>
                            <td><%out.print(user.getIdUsuario());%></td>
                            <td><%out.print(user.getNombre());%></td>
                            <td><%out.print(user.getApellidos());%></td>
                            <td><%out.print(user.getEmail());%></td>
                            <td><%out.print(user.getNoDocumento());%></td>
                            <td><%if (user.isActivo()) {
                                    out.print("Activo");
                                } else {
                                    out.print("Inactivo");
                            ...
                            <td>
                                <a href="../UserServlet?idtoUpdate=<%out.print(user.getIdUsuario());%>" title="Editar" class="NavLateral-DropDown  waves-effect waves-light"><i class="zmdi zmdi-edit zmdi-hc-fw"></i></a>
                                <a href="javascript:void(0)" title="Bloquear" onclick="deleteGeneral('../UserServlet?idtoDelete=<%out.print(user.getIdUsuario());%>')" title="Desactivar" class="NavLateral-DropDown  waves-effect waves-light"><i class="zmdi zmdi-delete zmdi-hc-fw"></i></a>
                            </td>
                        </tr>
