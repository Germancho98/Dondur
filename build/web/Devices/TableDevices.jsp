        ...
        <div class="content">
            ...
            <div class="fresh-table full-color-orange">
                ...
                <table id="fresh-table" class="table">
                    <center><h3 style="right:">Lista de Dispositivos</h3></center>
                    ...
                    <tbody>
                        <jsp:useBean id="DevicesController"  scope="page"  class="Controller.DeviceController"/>
                        <%
                            if (DevicesController.getDeviceList() != null && DevicesController.getDeviceList().size() > 0) {
                                for (Device device : DevicesController.getDeviceList()) {

                        %>

                        <tr>
                            <td><%out.print(device.getIdDispositivos());%></td>
                            <td><%out.print(device.getIMEI());%></td>
                            <td><%out.print(device.getModel().getNombreModelos());%></td>
                            <td><%out.print(device.getBrand().getNombreMarcas());%></td>
                            <td>
                                <a href="../DeviceServlet?idtoUpdate=<%out.print(device.getIdDispositivos());%>" title="Editar" class="NavLateral-DropDown  waves-effect waves-light"><i class="zmdi zmdi-edit zmdi-hc-fw"></i></a>
                            </td>
                        </tr>
